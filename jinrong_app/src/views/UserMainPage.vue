<template>
    <div id="header" class="header_main">个人中心<a onclick="back0();" class="back"></a></div>
    <div class="h60"></div>
...
<script>
    ...
    export default {
        ...
        data(){
           ...
           axios.post('/api/userImgUpload',userForm).then(function(response){
            var data=response.data;
           // alert(data.data.imgName);
               _this.imgName='/api/upload/'+data.data.imgName;
